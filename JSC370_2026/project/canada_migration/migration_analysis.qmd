...
g_4c = (
    ...
    + p9.labs(title="Net Migration by CMA Size Category (Train 2001–2018)", x="Year", y="Mean migration", color="Size group")
    + p9.theme_minimal()
...
g_4d = (
    ...
    + p9.labs(title="Distribution Shift by Period, Faceted by CMA Size", x="", y="Migration")
...
# 4e) CMA-level share_65plus vs migration scatterplots
share65_scatter = (
    eda.melt(
...
g_4e = (
    ...
    + p9.scale_color_manual(values=size_colors, limits=size_order)
    + p9.labs(
        title="share_65plus vs Net Migration (Train 2001–2018)",
...
make_top_bottom_slope_plot(
    ...
    "Top/Bottom Unit Trends in Net Intraprovincial Migration (Train, avg rate of change)",
)
make_top_bottom_slope_plot(
    "net_interprovincial",
    "4f_unit_trends_top_bottom_interprov_slopes_train.png",
    "4f_unit_interprov_slopes_train.csv",
    "Top/Bottom Unit Trends in Net Interprovincial Migration (Train, avg rate of change)",
)
